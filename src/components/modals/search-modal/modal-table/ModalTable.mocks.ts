...
import { IModalTable } from "./ModalTable";

const base: IModalTable = {
  ebaySearchResults: [
    {
      itemId: "204236636211",
  ...
  selectedProducts: [],
  setSelectedProducts: () => {},
  headers: ["Title", "Listed On", "Type", "Price", "Shipping", "Total"],
};

export const mockModalTableProps = {
  base,
};
